...
function GalleryHero() {
  return (
    <section className="relative overflow-hidden bg-deep">
      <img src="/hero background.webp" alt="" className="absolute inset-0 h-full w-full object-cover opacity-60" fetchPriority="high" />
  ...
  return (
    <>
      ...
      <div className="bg-ice">
        <GallerySection id="featured" subtitle="Our Work" title="Featured Projects" images={FEATURED_PROJECTS} />
        <GallerySection id="facilities" subtitle="Behind the Scenes" title="Workshop & Facilities" images={WORKSHOP_FACILITIES} />
        <GallerySection id="team" subtitle="The People" title="Our Team in Action" images={TEAM_IN_ACTION} />
      </div>
      <CtaSection />
    </>
  );
