...
function PageHero() {
  return (
    <section className="relative overflow-hidden bg-deep">
      <img src={PHOTOS.ripple} alt="" className="absolute inset-0 h-full w-full object-cover opacity-40" fetchPriority="high" />
...
function Purification() {
  ...
  return (
    <section className="relative overflow-hidden bg-deep py-12 sm:py-16 md:py-20 xl:py-24">
      <img src="/operations.webp" alt="" className="absolute inset-0 h-full w-full object-cover opacity-30" loading="lazy" />
